		...
		public static void RegisterBundles(BundleCollection bundles)
		{
			...
			stylebundle = new StyleBundle("~/layout1/style")
			   ...
			   .Include("~/css/custom-admin.css", new CssRewriteUrlTransform())
				.Include("~/dist/assets/css/bootstrap-touchspin.rtl.css", new CssRewriteUrlTransform())
				;
			...
			scriptbundle = new Bundle("~/layout1/script")
				...
				.Include("~/dist/assets/vendor/jquery.bootstrap-touchspin.js")
				.Include("~/dist/assets/js/touchspin.js")
				.Include("~/js/script-admin.js")
